...
function getExtPaths(extRoot, jsFile, rtl) {
    ...
    if (isExtNightly) {
        ...
        return {
            jsRoot  : extRoot,
            cssRoot : extRoot + '/resources/css',
            js      : extRoot + '/' + jsFile,
            css     : extRoot + '/resources/css/ext-all.css'
        };
    }
}
    ...
    var suite = [
        ...
        },
        {
            ...
            items           : [
                ...
                },
                {
                    ...
                    preload : [ extPaths.jsRoot + "/ext-dev.js" ]
                },
                {
            ...
            items : [
                {
                    ...
                    url                 : 'plugins/080_zones.t.js?quirks'
                },
                {
                    scopeProviderConfig : { useStrictMode : true },
                    url                 : 'plugins/080_zones.t.js?strict'
                },
        ...
        },
        {
            ...
            items : [
                ...
                {
                    alsoPreload : ['../../ExtGantt2.x/gnt-all-debug.js'],
                ...
                {
                    scopeProviderConfig : { useStrictMode : false },
                    url                 : 'event/066_event_accessibility.t.js?quirks'
                },
                {
                    scopeProviderConfig : { useStrictMode : true },
                    url                 : 'event/066_event_accessibility.t.js?strict'
                },
                {
        ...
        },
        {
            ...
            items : [
                ...
                'header/200_timeaxisview_model_calendar.t.js',
                {
        ...
        },
        {
            ...
            items : [
                ...
                'view/2112_filtered_time_axis.t.js',
                {
                    preload : [
                        extPaths.cssRoot + "/ext-all.css",
                        extPaths.jsRoot + "/ext-all-dev.js",
                        '../resources/css/sch-all.css',
                        '../sch-all' + (debug ? '-debug' : '') + '.js'
                    ],
...
//                'buffered_rendering/100_buffered_tree.t.js'
        ...
        // tests for tree filtering - checking "pure-Ext" implementation
        {
            ...
            preload : [
                ...
                '../js/Sch/data/FilterableNodeStore.js',
...
for (var i = 0; i < targetExtVersions.length; i++) {
    ...
    var extPaths = getExtPaths(root, 'ext-all' + (debug ? '-debug' : ($.browser.webkit ? '-dev' : '')) + '.js');
...
if (!extRoot && !isSmokeTest) {
    ...
    var exampleUrls =
            [
                ...
                'bufferedview/bufferedview.html',
                ...
                //'googlecalendar/googlecalendar.html',
    ...
    topItems.push(
        {
            ...
            items : exampleItems.concat(
                location.href.match(/ExtScheduler2\.x-current/) ?
                    []
                    :
                    [
                        {
