StartTest(function (t) {
    ...
    t.describe('Horizontal and Vertical Layout', function(t) {
        ...
        t.it('Unit test Horizontal Layout', function (t) {
            ...
            t.expect(sortedEvents[0].internalId).toBe('e10');
        ...
        t.it('Integration test', function (t) {
            ...
            t.chain(
                ...
                function (next) {
                    ...
                    var e10 = t.compositeQuery('schedulergrid gridpanel => .x-grid-row:nth-child(1) > .sch-timetd .sch-event[id$=e10]');
                    var e11 = t.compositeQuery('schedulergrid gridpanel => .x-grid-row:nth-child(1) > .sch-timetd .sch-event[id$=e11]');

                    t.isGreater(Ext.fly(e11[0]).getY(), Ext.fly(e10[0]).getY(), 'Horizontal position: e10 is first item');
                ...
                function (next) {
                    ...
                    t.isGreater(Ext.fly(e11[0]).getX(), Ext.fly(e10[0]).getX(), 'Vertical position: e10 is first item');
                }
            );
        })
