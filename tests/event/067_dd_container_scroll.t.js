StartTest(function (t) {
    ...
    t.it("Should scroll vertically, when dragging event to the top/bottom edge of the view", function (t) {
        ...
        t.chain(
            ...
            function (next) {
                t.isGreater(viewEl.child('table').getWidth(), viewEl.getWidth(), 'Enough width to scroll');
                t.isGreater(viewEl.child('table').getHeight(), viewEl.getHeight(), 'Enough height to scroll');
