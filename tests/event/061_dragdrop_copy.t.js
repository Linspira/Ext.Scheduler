StartTest(function (t) {
    ...
    var getTestSteps = function(t) {
        return [
            ...
            function (next) {
                ...
                var eventCopy = scheduler.resourceStore.getById('r2').getEvents()[0];

                t.ok(!draggedRecord.modified.StartDate, 'StartDate not changed');
                t.ok(!draggedRecord.modified.EndDate, 'EndDate not changed');
    ...
    t.it('Scheduler with TaskStore', function (t) {
        ...
        scheduler = getScheduler({
            ...
            eventStore    : new Gnt.data.TaskStore({
