StartTest(function (t) {
    ...
    var eventSM = scheduler.getSchedulingView().getSelectionModel();

    t.isInstanceOf(scheduler.getEventSelectionModel(), Sch.selection.EventModel, 'Correct sel model found');
