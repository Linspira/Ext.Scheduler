StartTest(function (t) {
    ...
    t.it('Basic API tests', function (t) {
        ...
        t.knownBugIn('4.2.3', function (t) {
            t.isStrict(scheduler.normalGrid.sortableColumns, false, 'NormalGrid config setting sortableColumns')
        ...
        t.chain(
            ...
            function () {
                ...
                t.click(t.getFirstCell(scheduler.lockedGrid));
                t.click(t.getFirstCell(scheduler.normalGrid));
            }
        )
    })
