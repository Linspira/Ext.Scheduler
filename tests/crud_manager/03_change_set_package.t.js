StartTest(function(t) {
    ...
    t.it('Change set package for modified data', function (t) {
        ...
        t.isDeeply(pack.resources.added, [{ Name : 'New Resource', '$PhantomId' : newResource[0].internalId }], 'Correct list of added records');
        ...
        t.isDeeply(pack.something.added, [{ f1 : '55', f2 : '555', '$PhantomId' : newRec[0].internalId,
            // embedded store changes
            f3: {
                '$store'    : true,
                added       : [{ ff1 : 'xx', ff2 : 'xxx', '$PhantomId' : newSubRec[0].internalId }],
                updated     : [{ id : 1, ff1 : '!11' }],
                removed     : [{ id : 4 }]
            }
