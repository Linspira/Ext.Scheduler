    ...
    t.it('Should be possible to save some resources and events', function (t) {
        t.chain(
            ...
            function (next) {
                ...
                var events      = resource1.getEvents();
            ...
            function (next) {
                ...
                t.isDeeply(resource3.getEvents(), [event2], 'Event #1 has resource3 assigned');
            ...
            function (next) {
                ...
                t.isDeeply(resource1.getEvents(), [event1], 'Event #0 has resource1 assigned');
                t.isDeeply(resource3.getEvents(), [event2], 'Event #1 has resource3 assigned');
