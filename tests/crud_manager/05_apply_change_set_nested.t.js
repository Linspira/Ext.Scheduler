StartTest(function(t) {
    ...
    Ext.define('TestModel', {
        ...
        constructor : function (config) {
            ...
            if (this.data.f3 || this.raw.f3) {
                this.f3Store    = this.data.f3 || this.raw.f3;
            }
        },
    ...
    var initTestData = function () {
        ...
        response = {
            someStore1  : {
                rows    : [
                    { $PhantomId : added1[0].internalId, id : 14 },
                    { id : 12, ff2 : '-222' }
                ],
                removed : [{ id : 11 }]
            },
            someStore2  : {
                rows    : [
                    {
                        $PhantomId  : added2.internalId,
                        id          : 5,
                        // sub-store changes response
                        f3          : {
                            rows    : [
                                { $PhantomId : subAdded2[0].internalId, id : 8 },
                                { id : 6, d : '!dd' }
                            ],
                            removed : [{ id : 5 }]
                        }
                    },
                    {
                        ...
                        f3          : {
                            rows    : [
                                { $PhantomId : subAdded1.internalId, id : 22 },
                                { id : 2, b : '!xxx' }
                            ],
                            removed : [{ id : 1 }]
                        }
