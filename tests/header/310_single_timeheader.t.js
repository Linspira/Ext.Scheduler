StartTest(function (t) {
    ...
    t.waitForRowsVisible(scheduler, function () {
        ...
        t.doubleClick(scheduler.el.down('.sch-header-row-bottom .sch-column-header'));
        ...
        t.doubleClick(scheduler.el.down('.sch-header-row-middle .sch-column-header'));
        ...
        t.doubleClick(scheduler.el.down('.sch-header-row-top .sch-column-header'));
