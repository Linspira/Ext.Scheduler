StartTest(function (t) {
    ...
    t.expectGlobals('BaseModel', 'SubModel', 'SubSubModel');
    ...
    t.it('Model.set should return array of modified fields', function (t) {
        ...
        t.isDeeply(instance.set('Field1'), ['Field1'], 'Array returned');
    });
    ...
    t.it('Testing the base model (the one with customizableFields property)', function (t) {
        ...
        var baseModelFields = BaseModel.prototype.fields.items || BaseModel.prototype.fields
    ...
    t.it('Testing the sub model (the one inheriting from base model, and w/o customizableFields)', function (t) {
        ...
        var subModelFields = SubModel.prototype.fields.items || SubModel.prototype.fields
    ...
    t.it('Testing the sub sub model', function (t) {
        ...
        var subsubModelFields = SubSubModel.prototype.fields.items || SubSubModel.prototype.fields
