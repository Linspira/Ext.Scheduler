    ...
    t.describe('Assert the flow of the export', function (t) {
        ...
        t.waitForRowsVisible(scheduler, function () {
            ...
            t.it('Single export buffered', function (t) {
                ...
                scheduler.normalGrid.view.bufferedRenderer.scrollTo(50, false, function () {
                    ...
                    plugin.doExport({
                        ...
                        // TODO: need to make separate tests for exporter classes and mover these assertions there
            ...
            t.it('Multipage export (vertical)', function (t) {
                ...
                plugin.doExport({
                    ...
                    t.is(exported.htmlArray.length, 4, 'proper number of pages exported');
