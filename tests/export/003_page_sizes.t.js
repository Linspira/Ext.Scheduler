StartTest(function(t) {
    ...
    var plugin      = new Sch.plugin.Export({
        ...
        test            : true,
        // add a custom page size
        pageSizes       : Ext.apply(Sch.plugin.Export.prototype.pageSizes, {
            foo     : {
                width   : 8.5,
                height  : 11
            }
    ...
    t.isGreater(plugin.win.form.formatField.store.find('field1', 'foo'), -1, 'added format is displayed in the drop down list');
    ...
    t.waitForRowsVisible(scheduler, function () {
        ...
        function (response) {
             ...
             *      plugin.pageSizes.foo.height * plugin.DPI - scheduler.normalGrid.headerCt.getHeight() - pageHeaderHeight
