    ...
    t.it('VERTICAL getResourceRegion', function(t) {
        ...
        t.chain(
            ...
            function(next) {
                ...
                t.isApprox(region.bottom, view.el.down('table').getHeight(), 1, 'getResourceRegion vertical: region bottom ok');

                t.diag('getScheduleRegion');
    ...
    t.it('HORIZONTAL getScheduleRegion', function(t) {
        ...
        t.chain(
            ...
            function(next) {
                ...
                var tableRegion = view.el.down('.x-grid-table').getRegion();
