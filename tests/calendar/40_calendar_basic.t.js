StartTest(function (t) {
    ...
    t.it('Drag drop should work correct', function (t) {
        ...
        t.chain(
            ...
            { drag : '.event-1', offset : [20, 20], by : [-40, 0] },//to : '.sch-calendar tr.x-grid-row:nth-child(3) .sch-timetd:nth-child(2)' }
            function (next) {
    ...
    t.it('Drag create should work correct', function (t) {
        ...
        t.chain(
            { waitForEventsToRender : scheduler },
            // drag create
            { drag : ".sch-calendar .x-grid-row:nth-child(3) .sch-timetd", offset : [20, 5], by : [0, 31], dragOnly : true },
...
//            // drag create
            { drag : ".sch-calendar .x-grid-row:nth-child(4) .sch-timetd", offset : [97, 8], by : [-4, 30] },
            function (next) {
