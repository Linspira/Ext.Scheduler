StartTest(function(t) {
    ...
    var treeStore, nodeStore, treePanel
    ...
    t.it("Should re-apply filter after loading new dataset", function (t) {
        ...
        treeStore.hideNodesBy(function (node) {
            if (this != scopeHide) t.fail("Wrong scope for hide method")
            
            return node.get('name') == 'hidden'
        }, scopeHide)
        ...
        t.firesOk({
            ...
            desc            : '3 refresh events should be fired when re-loading the tree store - 1 for ExtJS "removeAll"' + 
                ' 1 for our override which fires "clear" event on the nodeStore  and 1 for fresh data'
        })
