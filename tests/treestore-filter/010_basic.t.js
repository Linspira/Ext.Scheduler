StartTest(function(t) {
    ...
    t.isDeeply(nodeStore.getRange(), [ id(2), id(3), id(4), id(5) ], 'Only matching nodes and their parents left in view after filtering')
    ...
    t.isDeeply(nodeStore.getRange(), [ id(1), id(2), id(3), id(4), id(5), id(6) ], 'Clearing filter restored all nodes')
    ...
    t.isDeeply(nodeStore.getRange(), [ id(1), id(2), id(5), id(6) ], '`hideNodesBy` should hide node 3 and its childe node 4')
    ...
    t.isDeeply(nodeStore.getRange(), [ id(5) ], 'Hiding + filtering works, different arguments format also works')
    ...
    t.isDeeply(nodeStore.getRange(), [ id(1), id(2), id(3), id(4), id(5), id(6) ], '`showAllNodes` showed all nodes')
})    
