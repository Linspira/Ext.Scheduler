...
// SETUP CODE
    ...
    var getIdRange  = function () { return Ext.Array.map(nodeStore.getRange(), function (node) { return node.getId() }) }
...
// EOF SETUP CODE
    ...
    t.it('Should allow to hide a first child of some node', function (t) {
        ...
        nodeStore.setNode(treeStore.getRootNode())
