StartTest(function(t) {
    ...
    t.isDeeply(nodeStore.getRange(), [ id(1), id(2), id(3), id(6) ], 'Only matching nodes and their parents left in view after filtering')
    ...
    t.isDeeply(nodeStore.getRange(), [ id(1), id(6) ], 'Only matching nodes and their parents left in view after filtering')
