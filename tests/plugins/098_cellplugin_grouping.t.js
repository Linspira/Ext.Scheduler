...
//                hideGroupedHeader  : true,
    ...
    var getCellPosition = function (col, resource) {
        ...
        var node    = scheduler.view.el.down('.x-grid-data-row[data-recordid=' + resource.getId() + ']');
    ...
    var checkDimensions = function (t, box, col, row, eventBox) {
        ...
        if (eventBox) {
            ...
            node = Ext.get(scheduler.getSchedulingView().getNodeByRecord(row));
    ...
    t.it('Should destroy highlighter when group with selected resource is collapsed', function (t) {
        ...
        t.chain(
            { click : ".x-grid-row:nth-child(5) .sch-timetd", offset : [77, 11] },
            { click : "#Group2" },
            function (next) {
    ...
    t.it('Should update/move highlighter when previous group is collapsed', function (t) {
        ...
        t.chain(
            { click : "tr.x-grid-row:nth-child(7) .sch-timetd", offset : [93, 14] },
            { click : "#Group2" },
            function (next) {
