StartTest(function (t) {
    ...
    t.it('Selection-related event arguments are correct', function (t) {
        ...
        t.chain(
            ...
            { click : ".x-grid-row:nth-child(3) .sch-timetd", offset : [195, 16] },
            function (next) {
                plugin.on('beforeselect', function (view, resource, startDate, endDate) {
            ...
            { click : ".x-grid-row:nth-child(4) .sch-timetd", offset : [195, 14] },
            function (next) {
                plugin.on('beforeselect', function (view, resource, startDate, endDate) {
            ...
            { click : ".x-grid-row:nth-child(5) .sch-timetd", offset : [309, 18], options : { ctrlKey : true } }
        );
    });
    ...
    t.it('Should cancel selection', function (t) {
        ...
        t.chain(
            ...
            { click: ".x-grid-row:nth-child(2) .sch-timetd", offset : [156, 20] },
            function (next) {
    ...
    t.it('Should distinguish click and double click', function (t) {
        ...
        t.chain(
            ...
            { click: ".x-grid-row:nth-child(2) .sch-timetd", offset : [156, 20] },
            { dblclick: ".x-grid-row:nth-child(2) .sch-timetd", offset : [300, 40] }
        );
    });
});