StartTest(function (t) {
    ...
    t.it('Plugin should work correctly after time axis is reconfigured', function (t) {
        ...
        t.chain(
            ...
            { click : ".x-grid-row:nth-child(4) .sch-timetd", offset : [115, 11] },
            { waitForSelector : '.sch-cellplugin-highlighter' },
            function (next) {
    ...
    t.it('Should destroy highlighter on zoom change', function (t) {
        setup({
            listeners   : {
                timeheaderclick     : function(column, startDate, endDate, e, eOpts){                   
        ...
        t.chain(
            { click : ".x-grid-row:nth-child(2) .sch-timetd", offset : [90, 15] },
            { click : ">>timeaxiscolumn[text=&#160;]", offset : [87, 26] },
            function (next) {
    ...
    t.it('Schould destroy highlighter after event store refresh', function (t) {
        ...
        t.chain(
            { click : ".x-grid-row:nth-child(2) .sch-timetd", offset : [147, 10] },
            function (next) {
