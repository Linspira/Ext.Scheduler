    ...
    createGrid : function() {
        ...
        Ext.define('Reservation', {
            ...
            fields: [
                ...
                {name: 'EndDate', type : 'date', convert : function(v, r) { return Sch.util.Date.add(r.getStartDate()||Ext.Date.parseDate(r.raw.StartDate, "Y-m-d"), Sch.util.Date.DAY, r.raw.NbrNights);}}
            ]
        });
        ...
        var g = new Ext.create("Sch.panel.SchedulerGrid", {
            ...
            allowOverlap : false,
            rowHeight : 90,
            viewConfig : { barMargin : 10, forceFit : true },
            loadMask : { store : reservationStore },

            // Setup static columns
            columns : [
               {header : 'Name', dataIndex : 'Name', sortable:true, width:250, xtype:'templatecolumn', tpl : cabinTpl }
            ],
