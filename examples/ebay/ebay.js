...
Ext.onReady(function() {
    ...
    Ext.define('AuctionItem', {
        ...
        fields : [
            ...
            {name: 'GalleryUrl', convert : function(v, r) {
                return r.raw.galleryURL ? r.raw.galleryURL[0] : Ext.BLANK_IMAGE_URL;
            }},
    ...
    itemStore.on({
        ...
        'load' : function() {
            var rs = [];
            Ext.each(this.proxy.reader.jsonData.findItemsAdvancedResponse[0].searchResult[0].item, function(o) {
                rs.push({ Id : o.itemId });
            });
