    ...
    init : function () {
        ...
        var sched = App.sched = Ext.create("Sch.panel.SchedulerGrid", {
            ...
            eventStore        : Ext.create("Sch.data.EventStore", {
                model : 'Event',
                data  : [
                    {ResourceId : 'MadMike', Type : 'Call', Title : 'Assignment 1', StartDate : "2011-12-09 10:00", EndDate : "2011-12-09 11:00"},
                    {ResourceId : 'KarenJohnson', Type : 'Call', Title : 'Customer call', StartDate : "2011-12-09 14:00", EndDate : "2011-12-09 16:00"},
                    {ResourceId : 'LindaAnderson', Type : 'Meeting', Title : 'Assignment 2', StartDate : "2011-12-09 10:00", EndDate : "2011-12-09 12:00"}
                ]
            }),
